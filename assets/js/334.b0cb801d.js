...
// EXTERNAL MODULE: ./node_modules/dayjs/esm/constant.js
var constant = __webpack_require__(97706);
...
;// CONCATENATED MODULE: ./node_modules/dayjs/esm/plugin/advancedFormat/index.js
...
;// CONCATENATED MODULE: ./node_modules/mermaid/dist/ganttDiagram-3bc7fa50.js
...
esm/* default */.Z.extend(isoWeek);
esm/* default */.Z.extend(customParseFormat);
esm/* default */.Z.extend(advancedFormat);
let dateFormat = "";
let axisFormat = "";
...
const draw = function(text, id, version, diagObj) {
  ...
  function makeGrid(theSidePad, theTopPad, w2, h2) {
    ...
    if (resultTickInterval !== null) {
      ...
      switch (interval) {
        case "minute":
          bottomXAxis.ticks(src/* timeMinute */.Z_i.every(every));
          break;
        case "hour":
          bottomXAxis.ticks(src/* timeHour */.WQD.every(every));
          break;
        case "day":
          bottomXAxis.ticks(src/* timeDay */.rr1.every(every));
          break;
        case "week":
          bottomXAxis.ticks(src/* timeWeek */.NGh.every(every));
          break;
        case "month":
          bottomXAxis.ticks(src/* timeMonth */.F0B.every(every));
          break;
      }
    }
    ...
    if (diagObj.db.topAxisEnabled() || conf.topAxis) {
      ...
      if (resultTickInterval !== null) {
        ...
        switch (interval) {
          case "minute":
            topXAxis.ticks(src/* timeMinute */.Z_i.every(every));
            break;
          case "hour":
            topXAxis.ticks(src/* timeHour */.WQD.every(every));
            break;
          case "day":
            topXAxis.ticks(src/* timeDay */.rr1.every(every));
            break;
          case "week":
            topXAxis.ticks(src/* timeWeek */.NGh.every(every));
            break;
          case "month":
            topXAxis.ticks(src/* timeMonth */.F0B.every(every));
            break;
        }
      }
