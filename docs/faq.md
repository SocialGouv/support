...
- Puis utiliser psql directement : `docker run --rm -ti postgres:10 psql posgres://[app]admin%40[app]devdevserver:[password]@host.docker.internal:1111?sslmode=require`
